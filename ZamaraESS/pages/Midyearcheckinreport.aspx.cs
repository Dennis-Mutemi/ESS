...
{
    public partial class Midyearcheckinreport : System.Web.UI.Page
    {
        ...
        protected void period_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {           
                ...
                {
                    Base64Report = MyComponents.HrService.GenerateReports(4, Session["username"].ToString(), Appraisalperiod);
                }
                else
                {
                    Base64Report = MyComponents.HrServiceZarib.GenerateReports(4, Session["username"].ToString(), Appraisalperiod);
                }
