...
{
    public partial class AppraisalReports : System.Web.UI.Page
    {
        ...
        protected void period_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {            
                ...
                {
                   Base64Report = MyComponents.HrService.GenerateReports(1, Session["username"].ToString(), Appraisalperiod);
                }
                else
                {
                    Base64Report = MyComponents.HrServiceZarib.GenerateReports(1, Session["username"].ToString(), Appraisalperiod);
                }
