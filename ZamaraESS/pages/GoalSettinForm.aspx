<%@ Page Language="C#" Title="Goal Setting Form" AutoEventWireup="true" MasterPageFile="~/pages/Main.Master" CodeBehind="GoalSettinForm.aspx.cs" Inherits="ZamaraESS.pages.AppraisalReports" %>
        ...
        <div class="container-fluid">
             <div class="card bg-gradient-default cardposition">
                <div class="card-header border-1">
                    <h3 class="card-title">
                        <strong>Goal Setting Form</strong>
                    </h3>                    
                </div>
                <div class="card-body">
                    <div class="row">
