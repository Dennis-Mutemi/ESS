...
{
    public partial class GoalSettingReport : System.Web.UI.Page
    {
        ...
        protected void period_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Base64Report = MyComponents.HrService.GenerateReports(3, Session["username"].ToString(), Appraisalperiod);
                }
                else
                {
                    Base64Report = MyComponents.HrServiceZarib.GenerateReports(3, Session["username"].ToString(), Appraisalperiod);
                }                   
