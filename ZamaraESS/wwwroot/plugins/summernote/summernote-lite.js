...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-info note-btn note-btn-info note-link-btn';
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-info note-btn note-btn-info note-image-btn';
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-info note-btn note-btn-info note-video-btn';
...
var videoDialog = function videoDialog(opt) {
  ...
  var footer = ['<button type="button" href="#" class="note-btn note-btn-info note-video-btn disabled" disabled>', opt.lang.video.insert, '</button>'].join('');
  return dialog({
...
var imageDialog = function imageDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-info note-btn-large note-image-btn disabled" disabled>', opt.lang.image.insert, '</button>'].join('');
  return dialog({
...
var linkDialog = function linkDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-info note-link-btn disabled" disabled>', opt.lang.link.insert, '</button>'].join('');
  return dialog({
    className: 'link-dialog',
